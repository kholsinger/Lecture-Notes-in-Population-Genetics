...
You'll get a report with the estimated effect at the 20 loci having the largest effect on the phenotype (sorted by largest effect to smallest). The first number is the posterior mean of the estimated effect and the numbers in parentheses are the lower and upper bound of the 95% credible interval.
...
summarize_analysis <- function(results, n_report = 20) {
  ...
  for (i in 1:n_report) {
    ...
    output <- sprintf("%6s: %8.5f (%8.5f, %8.5f)\n", 
