...
4. We then repeat that process to produce $N_samp$ different offspring populations. 
...
We'll discuss any general patterns that emerge and explore explanations for in lecture on 5 October.