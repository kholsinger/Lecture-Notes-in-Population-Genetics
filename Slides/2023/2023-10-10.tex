...
{\small
\[
  P(\mbox{coalescent at }t | \mbox{event at }t) =
  \frac{P(\mbox{coalescent})}{P(\mbox{coalescent} +
    P\mbox{migration})}
\]
}
...
{\small
\[
  P(\mbox{migration at }t | \mbox{event at }t) =
  \frac{P(\mbox{migration})}{P(\mbox{coalescent} +
    P\mbox{migration})}
\]
}
