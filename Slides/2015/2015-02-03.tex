...
\myslide{
{\bf\textcolor{blue}{Nei}}  - Treats populations as {\it fixed\/}
effects, i.e., alleles are sampled at random from populations, but we
ignore sampling of populations and loci

{\bf\textcolor{blue}{Weir \& Cockerham}} - Treats populations as {\it
  random\/} effects, i.e., populations~(and loci) are a sample from
all possible populations and loci and we're interested in making
statements about the ``all possible''
}
...
Weir \& Cockerham & 0.5398 & {\bf\textcolor{blue}{0.0387}} & 0.5577 \\
\hline
\end{tabular}
\end{center}
}
...
\myslide{
\begin{center}
\resizebox{0.7\textwidth}{!}{\includegraphics{beta-distribution.eps}}
\end{center}
}
