...
\myslide{
  \heading{Covariance between parents and offspring}
\begin{eqnarray*}
b_{P \rightarrow O}
&=& \frac{\Cov_{PO}}{\Var(P)} \\
...
\myslide{
  \heading{Estimating variance components}
\begin{center}
\begin{tabular}{l|ccc}
\hline\hline
        &      &             & Composition of \\
...
\myslide{
  \heading{Estimating variance components}
  \vfill
  For nested full-sib/half-sib analysis, all members of a maternal
  family are full sibs

\[
    \mbox{stan\_glmer(trait }\sim \mbox{(1}|\mbox{sire/dam), data = dat)}
\]

  For half-sib analysis, all members of a maternal family are half-sibs

\[
    \mbox{stan\_glmer(trait }\sim \mbox{(1}|\mbox{dam), data = dat)}
\]
\vfill
}
...
\myslide{
  \heading{Estimating variance components: example}
\begin{center}
\begin{tabular}{l|ccc}
\hline\hline
        &      &             & Composition of \\
