...
non-relatives must be due to similarities in their
genotypes.\index{resemblance between relatives}
...
just $\bar x$.\footnote{Notice that they have the same mean because
  they are half siblings. They share the same mother. Offspring from
  different mothers may have different means.}  Now with one locus,
