...
\section*{Association mapping}\index{association mapping}
...
model:\index{association mapping!regression}
\[
...
markers.\index{association mapping!relatedness} 
...
possible gametes:\footnote{Think of drawing the Punnett square for a
  dihybrid cross, if you want.}\index{two-locus genetics!gamete frequenies}
...
gametes independently of one another.\index{gametic disequilibrium}\index{two-locus genetics!gametic disequilibrium}\index{linkage disequilibrium}
