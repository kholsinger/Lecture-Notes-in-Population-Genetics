\chapter{Statistical phylogeography: Migrate-N and IMa}

There are several reasons why {\it gene trees\/} might not match {\it
  population trees}.\index{gene tree}\index{population tree}
...
you should ask.\index{migration!backwards migration rate}\index{backwards migration rate}
...
do then?\index{coalescent!drift-mutation-migration equilibrium}
