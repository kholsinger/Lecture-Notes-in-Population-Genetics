...
locus coding for alcohol dehydrogenase in {\it Drosophila
  melanogaster\/}\index{alcohol dehydrogenase}\index{Drosophila@\textit{Drosophila}!\textit{melanogaster}} might not only be subject to selection but that
...
interpreting it can be a little tricky.\index{Tajima's $D$!interpretation}
