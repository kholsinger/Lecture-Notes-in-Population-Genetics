...
\section*{An example}\index{Approximate Bayesian Computation!motivation}
...
straightforward.\footnote{OK. This maybe calling it ``relatively
  ...
  survived in this course, it may not look too
  awful.}\index{Approximate Bayesian Computation!algorithm}
...
\noindent {\bf Last updated in April 2017}
