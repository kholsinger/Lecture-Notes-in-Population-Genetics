...
Bateson, and Morgan).\index{biometricians}\index{Mendelians}
...
that wasn't particularly interesting.\index{quantitative
  traits}\index{blending inheritance}
...
environment.\index{norm of reaction}\index{phenotypic plasticity}
...
we're going to spend the next several weeks discussing.\index{polygenic inheritance}
...
$\Var(D)$.\footnote{We could even partition it further into additive
  ...
  epistatic variance, but let's not go there.}\index{phenotypic variance!partitioning}\index{genetic variance}\index{environmental variance}  
