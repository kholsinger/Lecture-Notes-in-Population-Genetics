...
we're going to spend the next three weeks discussing.\index{polygenic inheritance}
...
$\Var(D)$.\index{phenotypic variance!partitioning}\index{genetic variance}\index{environmental variance}  
