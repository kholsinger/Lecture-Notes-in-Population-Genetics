...
improve the function of the protein.\footnote{Obviously it happens
  ...
  genetics.''}\index{sledgehammer principle}
...
change the amino acid sequence.\index{sledgehammer
  principle}\footnote{Remember our discussion of the probability that
