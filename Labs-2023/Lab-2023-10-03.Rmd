...
* `n_repetitions` - The number of times that results from a particular combination of `N_e`, `m`, `mu`, and `n_islands` will be simulated for a particular choice of `n_loci`, `n_gen`, and `n_sample`.
...
cat("Finite island:  ", round(mean(result$Island), 3), ", ", round(sd(result$Island), 3), "\n",
