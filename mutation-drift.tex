...
alleles.\index{mutation!infinite alleles mode} Under this model we
...
\subsection*{A two-allele model with recurrent mutation}\index{geentic drift!mutation, recurrent}
...
all populations receive the fraction of migrants. Because any
...
a million individuals a piece or ten. One new immigrant every other
