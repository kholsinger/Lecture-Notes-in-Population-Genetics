...
\newcommand{\copyrightYears}{2004-2017}
...
We'll use {\tt Structure}\index{Structure@\texttt{Structure}} to assess whether
cultivated genotypes of {\it Berberis thunbergii\/}\index{Berberis@\textit{Berberis}!\textit{thunbergii}} contribute to
...
method.\index{Discriminant analysis of population structure} I
...
SNPs in less than 10 hours.\index{teraStructure@\texttt{teraStructure}}
